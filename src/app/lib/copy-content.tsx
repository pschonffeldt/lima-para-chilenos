...
export const WHAT_TO_EAT: ContentGridWithTagItem[] = [
  ...
  },
  {
    ...
    icon: "🍢",
    note: "Anticuchos de corazón a la parrilla, típicas de noche.",
  ...
  },
  {
    ...
    // href: "/comida/causa",
    icon: "🥔",
    note: "Entrada fría de papa amarilla rellena (pollo, atún o mariscos) y palta.",
...
export const DINING_STYLES: ThreeWaySectionItem[] = [
  ...
  },
  {
    ...
    icon: "👨‍🍳",
    blurb: [
      "Lima tiene restaurantes de clase mundial (Central y Maido).",
      "Reserva con anticipación; mesas se agotan rápido.",
      "Degustaciones/menús largos 2–3 h.",
...
export const DINING_ETIQUETTE: TwoWaySectionItem[] = [
  {
    ...
    icon: "🍽️",
    blurb: [
      "Pide recomendaciones de la casa.",
...
export const COFFEE_BASICS: ThreeWaySectionItem[] = [
  ...
  },
  {
    ...
    blurb: [
      ...
      "Si compras granos: tueste reciente (≤30 días) y molienda a pedido.",
...
export const COFFEE_SPOTS: ContentGridWithTagItem[] = [
  {
    ...
    // href: "/barrios/miraflores",
    icon: "🌊",
    note: "Espresso bars y filtrados a pasos de los parques costeros. Buenas tiendas para granos de origen. Plan: café → paseo por parques y miradores.",
  ...
  },
  {
    ...
    // href: "/barrios/barranco",
    icon: "🎨",
    note: "Cafeterías con terrazas, arte y murales a mano. Ideal para espresso tonic o cold brew en verano. Plan: café → Puente de los Suspiros → atardecer en mirador.",
  ...
  },
  {
    ...
    // href: "/barrios/lima-centro",
    icon: "🏛️",
    note: "Cafés de especialidad cerca de plazas y museos. Plan de día: museo → café → fotos, y regreso por app. Mantente en zonas concurridas.",
